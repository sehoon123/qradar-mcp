...
"""
Tests for DeleteReferenceTable
"""

import pytest
import httpx
from unittest.mock import AsyncMock
from qradar_mcp.tools.reference_data.delete_reference_table import DeleteReferenceTable


class TestDeleteReferenceTableMetadata:
    """Test DeleteReferenceTable metadata properties."""

    def test_tool_name(self):
        """Test tool name is correct."""
        tool = DeleteReferenceTable()
        assert tool.name == "delete_reference_table"
...
class TestDeleteReferenceTableExecution:
    """Test DeleteReferenceTable execution."""
...
class TestDeleteReferenceTableErrorHandling:
    """Test DeleteReferenceTable error handling."""
