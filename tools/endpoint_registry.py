...
ENDPOINT_SPECS: Dict[str, EndpointSpec] = {
    ...
    # Legacy reference data maps/tables. These APIs are older than collections,
    # but API 27 still documents maps/tables without a deprecation marker.
    "ListReferenceMaps": _spec("ListReferenceMaps", "list_reference_maps", "reference_data", "GET", "/reference_data/maps", legacy_api=True),
    "GetReferenceMap": _spec("GetReferenceMap", "get_reference_map", "reference_data", "GET", "/reference_data/maps/{name}", legacy_api=True),
    "CreateReferenceMap": _spec("CreateReferenceMap", "create_reference_map", "reference_data", "POST", "/reference_data/maps", read_only=False, legacy_api=True),
    "AddToReferenceMap": _spec("AddToReferenceMap", "add_to_reference_map", "reference_data", "POST", "/reference_data/maps/{name}", read_only=False, legacy_api=True),
    "DeleteReferenceMap": _spec("DeleteReferenceMap", "delete_reference_map", "reference_data", "DELETE", "/reference_data/maps/{name}", read_only=False, legacy_api=True),
    "RemoveFromReferenceMap": _spec("RemoveFromReferenceMap", "remove_from_reference_map", "reference_data", "DELETE", "/reference_data/maps/{name}/{key}", read_only=False, legacy_api=True),
    "ListReferenceTables": _spec("ListReferenceTables", "list_reference_tables", "reference_data", "GET", "/reference_data/tables", legacy_api=True),
    "GetReferenceTable": _spec("GetReferenceTable", "get_reference_table", "reference_data", "GET", "/reference_data/tables/{name}", legacy_api=True),
    "CreateReferenceTable": _spec("CreateReferenceTable", "create_reference_table", "reference_data", "POST", "/reference_data/tables", read_only=False, legacy_api=True),
    "AddToReferenceTable": _spec("AddToReferenceTable", "add_to_reference_table", "reference_data", "POST", "/reference_data/tables/{name}", read_only=False, legacy_api=True),
    "DeleteReferenceTable": _spec("DeleteReferenceTable", "delete_reference_table", "reference_data", "DELETE", "/reference_data/tables/{name}", read_only=False, legacy_api=True),
    "RemoveFromReferenceTable": _spec("RemoveFromReferenceTable", "remove_from_reference_table", "reference_data", "DELETE", "/reference_data/tables/{name}/{outer_key}/{inner_key}", read_only=False, legacy_api=True),
    ...
    "QradarDoctorTool": _spec(
        "QradarDoctorTool",
        "qradar_doctor",
        "help",
        "GET",
        "/help/versions",
        additional_required_endpoints=(("GET", "/help/endpoints"),),
    ),
